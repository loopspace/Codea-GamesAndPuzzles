...
local sr = {
    {quat(rt,rt,0,0),{1,3,-2}},
    {quat(rt,0,rt,0),{-3,2,1}},
    {quat(rt,0,0,rt),{2,-1,3}}
}
...
function Cube:restart()
    ...
    for k,v in ipairs(self.cubes) do
        rt[k] = v[3]:make_slerp(quat(1,0,0,0))
    ...
    for i=1,n do
        ...
        for j=1,n do
            ...
            for k=1,n,ki do
                ...
                table.insert(c,{define_cube(f),vec3(i,j,k),quat(1,0,0,0),sd,tf})
            end
        end
    end
    return c,s
